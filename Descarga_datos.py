# -*- coding: utf-8 -*-
"""
Created on Mon May 31 18:19:28 2021
...
class IBapi(EWrapper, EClient):
    ...
    def historicalDataEnd(self, reqId: int, start: str, end: str):
        ...
        self.df.to_csv("GBP_USD_1Y_5mins.csv",index=False)
        self.disconnect()
...
def defineContract(symbol,secType,exchange,currency='USD'):    #Objeto de trabajo 
    contract = Contract()
